...
public class HospApiController
{
    ...
    {
        Page<Hospital> hospitals = hospitalServise.selectHospPage(page, limit, hospitalQueryVo);
    ...
    {
        List<Hospital> list = hospitalServise.findByHosname(hosname);
    ...
    {
        Map<String, Object> map = hospitalServise.item(hoscode);
