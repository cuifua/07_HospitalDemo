...
import cuifua.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl implements ScheduleService
{
    ...
    public Map<String, Object> getRuleSchedule(long page, long limit, String hoscode, String depcode)
    {
        ...
        //获取医院名称
        String hosName = hospitalServise.getHospName(hoscode);
        //其他基础数据
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode)
    {
        ...
        //医院名称
        baseMap.put("hosname", hospitalServise.getHospName(hoscode));
    ...
    public ScheduleOrderVo getScheduleOrderVo(String scheduleId)
    {
        ...
        //获取预约规则信息
        Hospital hospital = hospitalServise.getByHoscode(schedule.getHoscode());
        if(null == hospital)
            throw new YyghException(ResultCodeEnum.DATA_ERROR);
        ...
        scheduleOrderVo.setHosname(hospitalServise.getHospName(schedule.getHoscode()));
    ...
    {
        //设置医院名称
        schedule.getParam().put("hosname",hospitalServise.getHospName(schedule.getHoscode()));
        //设置科室名称
